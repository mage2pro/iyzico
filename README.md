The extension integrates your Magento 2 based webstore with the **[iyzico](https://www.iyzico.com/en/)** Turkish payment service.
...
### 2. Self-installation
```
composer require mage2pro/iyzico:*
bin/magento setup:upgrade
rm -rf pub/static/* && bin/magento setup:static-content:deploy tr_TR en_US <additional locales, e.g.: fa_IR>
...
## Support
- [The extension's **forum** branch](https://mage2.pro/c/extensions/iyzico).
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/iyzico).
